...
select *from trans;
    ...
    -- 3. 샘플 데이터 (책 목록)
    INSERT INTO books (title, stock) VALUES ('자바의 정석', 3);
    INSERT INTO books (title, stock) VALUES ('스프링 인 액션', 2);
    INSERT INTO books (title, stock) VALUES ('토비의 스프링', 1);
    INSERT INTO books (title, stock) VALUES ('리액트 교과서', 5);
