...
export default function Component9(props){
    ...
    // [1] axios : React.js 주로 사용되는 REST API(JSON) 비동기 통신 함수,
    // [2] 사용법
    ...
    const onAxios1 = async()=>{
        ...
        console.log(response1.status); // HTTP 응답상태 코드 200
        console.log(response1.data); // HTTP 응답 자료
