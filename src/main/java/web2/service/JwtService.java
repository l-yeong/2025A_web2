...
public class JwtService {
    // [1] 개발자가 비밀키 정의, 32글자 이상의 문자열로 구성
    private String secret = "123456789123456789123456789123456789";
    // [2] 개발자가 정의한 비밀키를 이용한 sha-256 알고리즘
    ...
    public String createToken(String uid, String urole){
        String token = Jwts.builder()      //토큰 객체 생성 함수 시작
                .claim("uid",uid)       // uid 라는 key의 로그인성공한 회원아이디 저장
                .claim("urole",urole)   // urole라는 key의 로그인성공한 회원권한명 저장
